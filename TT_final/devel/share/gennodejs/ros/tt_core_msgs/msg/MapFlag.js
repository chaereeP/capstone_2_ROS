...
class MapFlag {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.track_state, buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MapFlag(null);
